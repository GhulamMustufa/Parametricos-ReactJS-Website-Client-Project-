...
function WhatwedoFooter() {
  return (
    <div>
       <div className="py-5 bg-primary">
          <div className="container">
            <div className="row pt-5 border-top">
              <div className="col-12 col-md"> <img className="img-fluid d-block mx-auto" src={Asset_44} width={100} /><small className="d-block text-muted mb-3 mt-2">Copyrights&nbsp;© Parametricos Ltd&nbsp;<br />, Cyprus&nbsp; 2018-2019</small> </div>
